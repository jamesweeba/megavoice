export default () => ({
  ...
  supabaseServiceRoleKey: process.env.SUPABASE_SERVICE_ROLE_KEY ||"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZiY3Buamx6cGZjcXFmZHlpbHpzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0OTcyNjIyMSwiZXhwIjoyMDY1MzAyMjIxfQ.uKzq9WBhTCy6eT7WQCs3lI8HxAJMirvSJxYGtcgm5zU",
